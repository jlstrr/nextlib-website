...
import { getLoggedInUser, changePassword } from "../../api/users";
          ...
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            ...
            <div className="flex items-center order-2 gap-2 grow xl:order-3 xl:justify-end">
              <button
                ...
                className="hidden xl:inline-flex ml-3 items-center gap-2 rounded-full border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200"
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 1C8.13 1 5 4.13 5 8v3H4a1 1 0 00-1 1v9a1 1 0 001 1h16a1 1 0 001-1v-9a1 1 0 00-1-1h-1V8c0-3.87-3.13-7-7-7zm3 11H9V8a3 3 0 016 0v4z" fill="currentColor"/>
                </svg>
                Change password
              </button>
            </div>
